...
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2 group">
    <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 group-hover:border-violet-500/50 group-hover:bg-violet-500/10 group-hover:shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all duration-300">
...
const CppIcon = () => (
  <div className="flex flex-col items-center gap-2 group">
    <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 group-hover:border-indigo-500/50 group-hover:bg-indigo-500/10 group-hover:shadow-[0_0_20px_rgba(99,102,241,0.3)] transition-all duration-300">
      <svg className="w-12 h-12 md:w-14 md:h-14" viewBox="0 0 128 128">
...
const About = () => {
  return (
    <section id="about" className="bg-gradient-to-b from-[#07050e] via-[#100726] to-[#090516] pt-24 pb-36 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      
      {/* Ambient glowing orbs */}
      <div className="absolute top-1/3 -left-32 w-96 h-96 bg-violet-600/15 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-fuchsia-600/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-center md:items-start relative z-10">
        ...
        <div className="flex flex-col items-center w-full md:w-[360px] shrink-0 mt-8 md:mt-0">
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            {/* Lanyard string */}
            <div className="absolute -top-32 left-1/2 w-3 h-40 bg-gradient-to-b from-black via-violet-950 to-black transform -translate-x-1/2 shadow-inner z-0 border-x border-violet-500/20"></div>
            {/* Lanyard clip */}
            ...
            {/* Badge Card */}
            <div className="bg-[#120a2a]/90 border border-violet-500/30 w-full max-w-[290px] rounded-3xl p-4 shadow-[0_25px_60px_rgba(0,0,0,0.7)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500 backdrop-blur-xl group">
              {/* Cutout Hole */}
              <div className="absolute -top-3 left-1/2 w-16 h-6 bg-[#120a2a] border-t border-violet-500/30 rounded-t-xl transform -translate-x-1/2 flex justify-center items-center">
                <div className="w-8 h-2 bg-black/60 rounded-full shadow-inner"></div>
              </div>
              {/* Image Container */}
              <div className="w-full aspect-square overflow-hidden rounded-2xl bg-black/60 border border-violet-500/40 relative shadow-inner">
                <img 
                  src={stackImage} 
                ...
                <div className="absolute bottom-3 left-3 right-3 text-left">
                  ...
                  <p className="text-violet-400 text-xs font-semibold">Full-Stack AI Engineer</p>
                </div>
              </div>

              {/* Badge Footer Meta */}
              <div className="mt-3.5 pt-3 border-t border-violet-500/20 flex justify-between items-center text-[11px] font-mono text-white/60">
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
                  Verified Creator
                </span>
                <span className="text-violet-400 font-bold">@codemechanic0</span>
              </div>
            </div>
          </div>
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-4 md:mt-0 relative z-20">
          ...
          <div className="inline-block border border-violet-500/30 rounded-full px-4 py-1 text-xs text-violet-400 font-bold mb-4 shadow-sm bg-violet-500/10 backdrop-blur-sm">
            About Me
          </div>
          ...
          <div>
            <p className="text-xs uppercase tracking-widest text-violet-400/80 font-bold mb-4 font-mono">
      ...
      <div className="absolute bottom-0 left-0 w-full pointer-events-none z-30 transform translate-y-1">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-12 md:h-16 fill-[#07050e]">
