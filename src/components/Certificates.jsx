...
const CertificateCard = ({ cert, aosDelay }) => (
  <div 
    ...
    className="bg-[#0f0924]/80 backdrop-blur-xl rounded-2xl p-5 border border-violet-500/20 hover:border-violet-400 hover:scale-105 hover:shadow-[0_15px_40px_rgba(139,92,246,0.2)] transition-all duration-500 cursor-default group"
  >
    <div className="flex items-start gap-4">
      ...
      <div>
        ...
        <p className="text-violet-400/80 text-xs font-semibold uppercase tracking-wider">
          {cert.issuer}
        </p>
      </div>
    </div>
...
const Certificates = () => {
  return (
    <section className="bg-gradient-to-b from-[#07050e] via-[#120829] to-[#07050e] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      
      {/* Background ambient lighting */}
      <div className="absolute top-1/2 -left-20 w-80 h-80 bg-violet-600/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute top-1/2 -right-20 w-80 h-80 bg-fuchsia-600/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" data-aos-delay="700" className="flex justify-center">
          <a
            ...
            className="flex items-center gap-3 px-8 py-3.5 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold text-base hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] hover:scale-105 transition-all duration-300 group"
          >
