...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-[#050f09]">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-emerald-400" aria-label="Instagram">
          ...
          >
            ...
            <a 
              ...
              className="px-5 py-2.5 md:px-7 md:py-3 text-xs md:text-sm rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold hover:shadow-[0_0_25px_rgba(16,185,129,0.6)] transition-all duration-300 transform hover:scale-105 shadow-md"
            >
            ...
            <a 
              ...
              className="px-5 py-2.5 md:px-7 md:py-3 text-xs md:text-sm rounded-full bg-[#050f09]/60 border border-emerald-500/40 text-white font-semibold hover:bg-emerald-950/50 hover:border-emerald-400 transition-all duration-300 backdrop-blur-md"
            >
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-14 h-14 md:w-20 md:h-20 rounded-full border border-emerald-500/50 bg-[#050f09]/50 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-emerald-600 transition-all duration-500 shadow-[0_0_30px_rgba(16,185,129,0.3)] group-hover:shadow-[0_0_45px_rgba(16,185,129,0.8)]">
            {!isPlaying ? (
              // Play Icon
