...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen h-dvh min-h-dvh overflow-hidden bg-[#050f09]">
      ...
      {/* Ambient Gradient Overlays - Subtle & cinematic so the video stays visible underneath */}
      ...
      <div className="absolute inset-0 z-20 px-4 sm:px-6 pb-6 sm:pb-8 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col justify-end text-left w-full pointer-events-none">
        ...
        <div className="pointer-events-auto flex flex-row items-end justify-between gap-3 sm:gap-6 w-full">
          ...
          {/* Right Side: Circular Play Reel Button (Unified on both Mobile and Desktop) */}
          <div 
            data-aos="zoom-in"
            data-aos-delay="500"
