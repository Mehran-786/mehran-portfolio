...
const Services = () => {
  ...
  return (
    <section 
      id="process"
      ref={containerRef}
      className="bg-[#fafafa] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800e_1px,transparent_1px),linear-gradient(to_bottom,#8080800e_1px,transparent_1px)] bg-[size:80px_80px]"
    >
